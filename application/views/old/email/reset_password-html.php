...
<html>
<head><title>Your new password on <?php echo $website_name; ?></title></head>
<body>
...
<h2 style="font: normal 20px/23px Arial, Helvetica, sans-serif; margin: 0; padding: 0 0 18px; color: black;">Your new password on <?php echo $website_name; ?></h2>
