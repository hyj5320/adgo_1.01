								...
								<?php foreach($list as $row){?>
									...
									?>
										<tr>
											...
											<td><input type="text" name="site_url" value="<?php echo $row->site_url;?>" placeholder="" style="height: 30px; width: 150px;"></td>
											<td><input type="text" name="email" value="<?php echo $row->email;?>" placeholder="" style="height: 30px; width: 150px;"></td>
											<td><input type="text" name="company" value="<?php echo $row->company;?>" placeholder="" style="height: 30px; width: 100px;"></td>
											<td><input type="text" name="username" value="<?php echo $row->username;?>" placeholder="" style="height: 30px; width: 100px;"></td>
											<td><input type="text" name="phone" value="<?php echo $row->phone;?>" placeholder="" style="height: 30px; width: 100px;"></td>
											<td>
												<select name="timezone1" class="select-block" style="width: 150px;">
											...
											<td><input type="text" name="created" value="<?php echo $row->created;?>" placeholder="" style="height: 30px; width: 100px;"></td>
											<td><input type="text" name="last_login" value="<?php echo $row->last_login;?>" placeholder="" style="height: 30px; width: 100px;"></td>
