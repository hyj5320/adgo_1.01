...
<h2 style="font: normal 20px/23px Arial, Helvetica, sans-serif; margin: 0; padding: 0 0 18px; color: black;">Welcome to <?php echo $website_name; ?>!</h2>
Thanks for joining <?php echo $website_name; ?>. We listed your sign in details below, make sure you keep them safe.<br />
